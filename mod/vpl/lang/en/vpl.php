...
$string ['extensionnotafterstartdate'] = 'Extension date must be after the start date';
$string ['file'] = 'File';
...
$string ['modifiedstartdate'] = 'Modified Start date';
$string ['modifiedduedate'] = 'Modified Due date';
